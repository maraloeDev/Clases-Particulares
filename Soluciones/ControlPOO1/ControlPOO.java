...
public class ControlPOO {
    ...
    public static void main(String[] args) {
        ...
        ControlPOO1.Cliente elCliente = new Cliente(0, "111-A", "Francisco", "Pérez", "Carrer de las Alforjas Viejas, 3", "+34654456456");
        // Crear la cuenta bancaria
        CuentaBancaria laCuenta;
        laCuenta = new CuentaBancaria("00781641", "3080053174", elCliente);
